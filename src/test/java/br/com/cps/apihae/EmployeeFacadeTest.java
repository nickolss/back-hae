...
import br.com.cps.apihae.adapter.controller.EmployeeController;
...
import br.com.cps.apihae.adapter.facade.EmployeeFacade;
...
public class EmployeeFacadeTest {
    ...
    void setup() {
        ...
        sampleResponse.setRole(br.com.cps.apihae.domain.enums.Role.PROFESSOR);
    }
        @Test
        ...
        void testGetAllEmployeesByRole() throws Exception {
                Mockito.when(employeeFacade.getEmployeeSummaries(br.com.cps.apihae.domain.enums.Role.PROFESSOR))
                                .thenReturn(Collections.singletonList(new br.com.cps.apihae.adapter.dto.response.EmployeeSummaryDTO("1", "John Doe", "john.doe@fatec.sp.gov.br", "ADS", 5)));
